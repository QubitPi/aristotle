...
public final class SystemConfigFactory {
     ...
     */
    private static final String SYSTEM_CONFIG_IMPL_KEY = "aristotle.systemConfigImpl";
    ...
    public static synchronized SystemConfig getInstance() {
        if (SYSTEM_CONFIG == null) {
            final String systemConfigImplementation = System.getenv(SYSTEM_CONFIG_IMPL_KEY);

            if (systemConfigImplementation == null) {
                return new AristotleSystemConfig(ConfigFactory.create(AristotleSystemConfig.InnerConfig.class));
            }
