...
- [Jekyll](http://jekyllrb.com/)
  ([direct link to code highlighting documentation](http://jekyllrb.com/docs/templates/#code-snippet-highlighting))
- [Pygments](http://pygments.org)

Hacking
-------

If you want to hack on the site, check out the
[gh-pages](https://github.com/jwarby/jekyll-pygments-themes/tree/gh-pages) branch.
